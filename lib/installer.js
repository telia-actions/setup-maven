...
function downloadMaven(version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const downloadUrl = `https://jfrog.teliacompany.io/artifactory/common-maven-remote-virtual/org/apache/maven/apache-maven/${version}/apache-maven-${version}-bin.tar.gz`;
